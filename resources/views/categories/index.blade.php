            ...
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                ...
                <div class="ms-auto d-flex">
                  <a class="btn-inner--text text-white" href="{{ route('categories.create') }}">
                        ...
                        <tr>
                          <td>
                            <div class="d-flex flex-column justify-content-center ms-1">
                                <p class="text-sm text-secondary mb-0">{{ $categories->firstItem() + $key }}</p>
                            </div>
                          </td>
                          ...
                          <td class="align-middle">
                            <a href="{{ route('categories.show', $row->id) }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Show page">
                              <i class="fa-regular fa-eye  text-primary" style="font-size: 0.9rem !important;" ></i>
                            </a>
                            <a href="{{ route('categories.edit', $row->id) }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit page">
