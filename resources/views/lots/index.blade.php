...
<div class="container my-3 py-3">
    <div class="row">     
      <form method="post" action="{{ route('lots.filter') }}">
        @csrf
        <div class="row">
          <div class="col-lg-4">
              <div class="form-group">
                  <label for="category_id">Category:</label>
                  <select multiple class="select2-multiple form-control" name="category_id[]">
            ...
            <div class="col-lg-2" style="height: fit-content;margin-top: 1.9rem !important;">
          ...
          <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-0">
              <div class="d-sm-flex align-items-center">
                <div>
                  <h6 class="font-weight-semibold text-lg mb-0">Lots</h6>
